...
export class AuthService {
  ...
  constructor(private messageService: MessageService, private http: HttpClient, private cookieService: CookieService, private jwtHelper: JwtHelperService) { }
  ...
  loadAuthFromCookie() {
    ...
    if (rawUser) {
      ...
      var token = JSON.parse(this.cookieService.get('token'))
    }
    return { user, token }
  }
